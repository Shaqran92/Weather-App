...
public class WeatherApp {
    ...
    public static JSONObject getWeatherData(String locationName){
        ...
        String urlString = "https://api.open-meteo.com/v1/forecast?" +
                ...
                "&current=is_day&hourly=temperature_2m,relativehumidity_2m,weathercode,windspeed_10m&timezone=Asia%2FKarachi";
    ...
    private static String convertWeatherCode(long weathercode){
        ...
        }else if(weathercode >= 1L && weathercode <= 2){
            // cloudy
            weatherCondition = "Mainly Clear";
        }else if(weathercode == 3L){
            // cloudy
            weatherCondition = "Cloudy";
        }else if(weathercode >= 45L && weathercode <= 48){
            // cloudy
            weatherCondition = "Fog";
        }else if(weathercode >= 51L && weathercode <= 57){
            // cloudy
            weatherCondition = "Drizzle";
        }else if(weathercode >= 95L && weathercode <= 99){
            // cloudy
            weatherCondition = "Thunderstorm";
        }else if((weathercode >= 56L && weathercode <= 67L)
